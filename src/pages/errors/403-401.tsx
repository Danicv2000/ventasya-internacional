...
export default function UnauthorizedPage() {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-white transition-colors duration-300">
      ...
      {/* Hidden template for 403 Forbidden message (can be toggled via JS in a real app) */}
      <div className="hidden" id="forbidden-state">
        {/* 
                This would be swapped in to replace the "Login Card" content 
                for users already logged in but lacking permissions.
            */}
