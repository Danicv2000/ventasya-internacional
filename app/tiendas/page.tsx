      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Navega por las mejores tiendas internacionales como si estuvieras comprando directamente en ellas. 
            Encuentra lo que buscas y déjanos traerlo para ti.
          </p>
        </div>
            ...
            {[
              {
                ...
                description: "Navega por las tiendas reales y selecciona exactamente lo que quieres"
              },
              {
                icon: <Globe className="size-8 text-purple-500" />,
                title: "Acceso Global",
                description: "Accede a millones de productos de tiendas internacionales"
              },
              {
                icon: <Package className="size-8 text-green-500" />,
                title: "Entrega Segura",
                description: "Recibe tus productos directamente en Cuba con seguimiento completo"
              }
            ].map((benefit, index) => (
        ...
        <div className="text-center mt-16">
          <p className="text-gray-600 mb-6 text-lg">
            ¿Prefieres calcular primero? Usa nuestra herramienta
          </p>
          <Link href="/calculadora">
